...
<div id="kanan">
	...
	<div id="slides">
		<?php
			...
			$queryBanner = mysqli_query($koneksi, "SELECT * FROM banner WHERE status='on' ORDER BY banner_id DESC LIMIT 6");
		...
		<?php
			...
			while($row=mysqli_fetch_assoc($query)){
				...
				echo "<li $style>
						...
						<a href='".BASE_URL."$row[barang_id]/$row[kategori]/$row[nama_barang].html'>
							<img src='".BASE_URL."images/barang/$row[gambar]' />
						</a>
						<div class='keterangan-gambar'>
							<p><a href='".BASE_URL."$row[barang_id]/$row[kategori]/$row[nama_barang].html'>$row[nama_barang] </a></p>
