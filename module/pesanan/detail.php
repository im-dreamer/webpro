...
<div id="frame-faktur">
	...
	<div id="frame-keterangan-pembayaran">
		<p>Silahkan Lakukan Pembayaran Ke Bank DSS<br/>
			Nomor Account : 1107-0509-1999 (A/N Webpro). <br/>
			Setelah melakukan pembayaran lakukan konfirmasi pembayaran <a href="<?php echo BASE_URL."index.php?page=my_profile&module=pesanan&action=konfirmasi_pembayaran&pesanan_id=$pesanan_id"?>">Disini</a>.
		</p>
	</div>