...
<?php
	...
	if(mysqli_num_rows($query) == 0){
		...
		$queryHitung = mysqli_query($koneksi, "SELECT * FROM barang $where");
		pagination($queryHitung, $data_per_halaman, $pagination, "index.php?page=my_profile&module=barang&action=list$search_url");
	}
?>